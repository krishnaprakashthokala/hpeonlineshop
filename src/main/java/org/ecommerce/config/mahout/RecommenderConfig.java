...
public class RecommenderConfig {
	...
	public Recommender provideAnonymousViewHistoryRecommender(@BooleanPrefDataModel DataModel dataModel)
		...
		UserNeighborhood neighborhood = new NearestNUserNeighborhood(3, userSimilarity, plusAnonymouDataModel);
		Recommender recommender = new GenericUserBasedRecommender(plusAnonymouDataModel, neighborhood, userSimilarity);
		return recommender;
	}

	@Bean
	@CollaborativeFilteringRecommender
	public Recommender provideCollaborativeFilteringRecommender(@RatingDataModel DataModel dataModel)
			throws TasteException {
